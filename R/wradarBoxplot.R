...
#' @param axistype The type of axis labeling to be used. Default is 0.
...
#' @examples
#' \dontshow{wradarBoxplot <- function (df, axistype = 0, seg = 4, pty = 16, pcol = 1:8, plty = 1:6,
...
#' wradarBoxplot(df, seg = 7, axistype = 2, title = "Variables", centerzero = TRUE,
